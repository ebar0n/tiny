...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Sun Apr 12 17:20:50 VET 2015
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\006\006\000\002\023\002\000\002\007\006\000\002\010" +
    ...
    "\003\000\002\015\003\000\002\017\005\000\002\016\010" +
    "\000\002\016\010\000\002\016\010\000\002\021\003\000" +
    "\002\021\004\000\002\021\003\000\002\021\003\000\002" +
    "\021\003\000\002\021\003\000\002\022\007" });
  ...
  protected static final short[][] _reduce_table = 
    ...
    "\014\026\015\027\001\001\000\004\023\051\001\001\000" +
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$parser$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 40: // call_funcion ::= ID LPAREN param_funcion RPAREN SEMI 
            {
		...
		NodoBase variables = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("call_funcion",16, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 39: // param_funcion ::= FALSE 
            {
              NodoBase RESULT =null;
		...
		Object falso = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
						...
						RESULT = new NodoParamFuncion(false);
					
              CUP$parser$result = parser.getSymbolFactory().newSymbol("param_funcion",15, ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 38: // param_funcion ::= TRUE 
            {
              NodoBase RESULT =null;
		...
		Object verdadero = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		...
		String variable = (String)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 if(modoDepuracion) System.out.println("\t regla parametros_funcion"); 
					if(variable!=null){
						...
						RESULT= new NodoParamFuncion(variable.toString());		
					}else{
						RESULT = null;
		...
		Integer valor = (Integer)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		 if(modoDepuracion) System.out.println("\t regla parametros_funcion"); 
					...
					if(valor!=null){
						RESULT= new NodoParamFuncion(valor);					
					}else{
						RESULT = null;
						System.out.println("Ocurrio error en cup # 0005");
					}
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 35: // param_funcion ::= param_funcion COMA 
            {
              NodoBase RESULT =null;
		int parametro2left = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).left;
		int parametro2right = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)).right;
		NodoBase parametro2 = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
		
				if(modoDepuracion) System.out.println("\t regla parametros_funcion");
				RESULT = new NodoParamFuncion(parametro2);
				
              CUP$parser$result = parser.getSymbolFactory().newSymbol("param_funcion",15, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-1)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 34: // param_funcion ::= param_funcion 
            {
              NodoBase RESULT =null;
		...
		NodoBase parametro = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 33: // funcion_stmt ::= BOOLEAN ID LPAREN decl_fun RPAREN bloque_stmt 
            {
              NodoBase RESULT =null;
		int f_type3left = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).left;
		int f_type3right = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).right;
		Object f_type3 = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-5)).value;
		int valor3left = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)).left;
		int valor3right = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)).right;
		String valor3 = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
		int decl3left = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int decl3right = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		NodoBase decl3 = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		...
		NodoBase exp3 = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
		
				if(modoDepuracion) System.out.println("\t regla funcion");
				RESULT = new NodoFuncion(f_type3,valor3,decl3,exp3);
				
              CUP$parser$result = parser.getSymbolFactory().newSymbol("funcion_stmt",12, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 32: // funcion_stmt ::= INT ID LPAREN decl_fun RPAREN bloque_stmt 
            {
              NodoBase RESULT =null;
		int f_type2left = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).left;
		int f_type2right = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).right;
		Object f_type2 = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-5)).value;
		int valor2left = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)).left;
		int valor2right = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)).right;
		String valor2 = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
		int decl2left = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).left;
		int decl2right = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)).right;
		NodoBase decl2 = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-2)).value;
		int exp2left = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).left;
		int exp2right = ((java_cup.runtime.Symbol)CUP$parser$stack.peek()).right;
		NodoBase exp2 = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 31: // funcion_stmt ::= VOID ID LPAREN decl_fun RPAREN bloque_stmt 
            {
              NodoBase RESULT =null;
		int f_typeleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).left;
		int f_typeright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-5)).right;
		Object f_type = (Object)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-5)).value;
		int valorleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)).left;
		int valorright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-4)).right;
		String valor = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-4)).value;
		...
		NodoBase exp = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.peek()).value;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 30: // bloque_stmt ::= BEGIN stmt_seq END 
            {
              NodoBase RESULT =null;
		...
		NodoBase exp = (NodoBase)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-1)).value;
              ...
              CUP$parser$result = parser.getSymbolFactory().newSymbol("bloque_stmt",13, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-2)), ((java_cup.runtime.Symbol)CUP$parser$stack.peek()), RESULT);
            }
          return CUP$parser$result;
